...
import MessagesDropdown from '@/layouts/beryllium/messages-dropdown';
import NotificationDropdown from '@/layouts/beryllium/notification-dropdown';
import ProfileMenu from '@/layouts/beryllium/profile-menu';
import SettingsButton from '@/layouts/beryllium/settings-button';
import HamburgerButton from '@/layouts/beryllium/hamburger-button';
import {
  PiChatCircleDotsFill,
  PiBellSimpleRingingFill,
  PiGearFill,
} from 'react-icons/pi';
import HeliumSidebar from './helium-sidebar';
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-2xl items-center">
        <HamburgerButton
          view={
            <HeliumSidebar className="static w-full xl:p-0 2xl:w-full [&>div]:xl:rounded-none" />
          }
        />
        <SearchWidget />
      </div>
